...
function createTimer() {
    ...
    const audioDiv = createElement("div", "gr-box", {
        style: "transition: all 0.15s ease; display: flex; align-items: center; padding: 5px; border: solid 1px #00FF8C; border-radius: 10px; background-color: rgba(0, 255, 140, 0.08) !important; cursor: pointer;",
        title: t.muteTooltip
    });
    ...
    const civitDiv = createElement("div", "gr-box", {
        style: "display: flex; align-items: center; padding: 5px; border: solid 1px #3399FF; border-radius: 10px; background-color: rgba(51, 153, 255, 0.08) !important; cursor: pointer;",
